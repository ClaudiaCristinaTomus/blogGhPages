      ...
      <div className="free">
        <div className="allFree">
          ...
          <div className="rightFree">
            <p className="titleFree">Free, open, simple</p>
            <p className="paragraphFree">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero est
              doloribus nemo sapiente in aut tempora, officia, repudiandae error
              beatae impedit. Repellendus quisquam delectus dolor, cum
              perspiciatis sint quia saepe.
            </p>
            <p className="titleFreeTwo">Powerful tooling</p>
            <p className="paragraphFreeTwo">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vero est
              doloribus nemo sapiente in aut tempora, officia, repudiandae error
              beatae impedit. Repellendus quisquam delectus dolor, cum
              perspiciatis sint quia saepe.
