      ...
      <div className="container">
        ...
        <nav className="desktop-menu">
          ...
          <div className="menu-item">
            <button
              onClick={() => handleDropdownToggle("page1")}
              className="menu-button"
              aria-expanded={activeDropdown === "page1"}
            >
              Product
            </button>
            {activeDropdown === "page1" && (
              <div className="dropdown">
                <a href="#page1-1" onClick={handleLinkClick} className="dropdown-item">Subpage 1-1</a>
                <a href="#page1-2" onClick={handleLinkClick} className="dropdown-item">Subpage 1-2</a>
                <a href="#page1-3" onClick={handleLinkClick} className="dropdown-item">Subpage 1-3</a>
              </div>
            )}
          </div>
          ...
          <div className="menu-item">
            <button
              onClick={() => handleDropdownToggle("page2")}
              className="menu-button"
              aria-expanded={activeDropdown === "page2"}
            >
              Company
            </button>
            {activeDropdown === "page2" && (
              <div className="dropdown">
                <a href="#page2-1" onClick={handleLinkClick} className="dropdown-item">Subpage 2-1</a>
                <a href="#page2-2" onClick={handleLinkClick} className="dropdown-item">Subpage 2-2</a>
                <a href="#page2-3" onClick={handleLinkClick} className="dropdown-item">Subpage 2-3</a>
              </div>
            )}
          </div>
          ...
          <div className="menu-item">
            <button
              onClick={() => handleDropdownToggle("page3")}
              className="menu-button"
              aria-expanded={activeDropdown === "page3"}
            >
              Connect
            </button>
            {activeDropdown === "page3" && (
              <div className="dropdown">
                <a href="#page3-1" onClick={handleLinkClick} className="dropdown-item">Contact</a>
                <a href="#page3-2" onClick={handleLinkClick} className="dropdown-item">Newsletter</a>
                <a href="#page3-3" onClick={handleLinkClick} className="dropdown-item">LinkedIn</a>
              </div>
            )}
          </div>
          ...
          <div className="auth-buttons">
            <button className="login-button" onClick={handleLinkClick}>Login</button>
            <button className="signup-button" onClick={handleLinkClick}>Sign Up</button>
          </div>
        </nav>
      ...
      {isMobileMenuOpen && (
        <nav className="mobile-menu">
          ...
          {activeDropdown === "page1" && (
            <div className="mobile-dropdown">
              <a href="#page1-1" className="mobile-dropdown-item">Subpage 1-1</a>
              <a href="#page1-2" className="mobile-dropdown-item">Subpage 1-2</a>
              <a href="#page1-3" className="mobile-dropdown-item">Subpage 1-3</a>
            </div>
          )}
          <a
            href="#page2"
          ...
          {activeDropdown === "page2" && (
            <div className="mobile-dropdown">
              <a href="#page2-1" className="mobile-dropdown-item">Subpage 2-1</a>
              <a href="#page2-2" className="mobile-dropdown-item">Subpage 2-2</a>
              <a href="#page2-3" className="mobile-dropdown-item">Subpage 2-3</a>
            </div>
          )}
          <a
            href="#page3"
          ...
          {activeDropdown === "page3" && (
            <div className="mobile-dropdown">
              <a href="#page3-1" className="mobile-dropdown-item">Subpage 3-1</a>
              <a href="#page3-2" className="mobile-dropdown-item">Subpage 3-2</a>
              <a href="#page3-3" className="mobile-dropdown-item">Subpage 3-3</a>
            </div>
          )}
          ...
          <a
            href="#signup"
            className="signup-button mobile-menu-item"
          >
            Sign Up
          </a>
        </nav>
       ...
       <div className="hero">
        <div className="textHero">
          <h1 className="titleHero">A modern publishing platform</h1>
          <p className="paragraphHero">Grow your audience and build your online brand</p>
        </div>
