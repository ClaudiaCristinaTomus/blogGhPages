    ...
    <div className='footer'>
        ...
        <div className='col2'>
            ...
            <div className='subtitles'>
                <p className='subt'>Overview</p>
                <p className='subt'>Pricing</p>
                <p className='subt'>Marketplace</p>
                <p className='subt'>Features</p>
                <p className='subt'>Integrations</p>
            </div>
        </div>
        <div className='col3'>
            <p className='title'>
            ...
            <div className='subtitles'>
                <p className='subt'>About</p>
                <p className='subt'>Team</p>
                <p className='subt'>Blog</p>
                <p className='subt'>Careers</p>
        ...
        <div className='col4'>
            ...
            <div className='subtitles'>
                <p className='subt'>Contact</p>
                <p className='subt'>Newsletter</p>
                <p className='subt'>Linkedin</p>
