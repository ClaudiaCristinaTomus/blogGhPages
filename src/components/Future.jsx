...
export const Future = () => {
  return (
    <>
    <div className="titleFuture">Designed for the future</div>
    <div className="sectionFuture">
      <div className="leftFuture">
        <div className="firstTextFuture">
          <p className="titlefirstTextFuture">
            Introducing an extensible editor
          </p>
          <p className="paragraphfirstTextFuture">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat
            quos et eaque at, excepturi optio facere quia inventore eveniet
            error sequi, quibusdam consequuntur aspernatur reprehenderit totam,
            accusamus voluptate accusantium illo?
          </p>
        </div>
        <div className="secondTextFuture">
          <p className="titlefirstTextFuture">Robust content management</p>
          <p className="paragraphfirstTextFuture">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat
            quos et eaque at, excepturi optio facere quia inventore eveniet
            error sequi, quibusdam consequuntur aspernatur reprehenderit totam,
      ...
      <div className="rightFuture desktop">
      ...
      <div className="rightFutureMobile mobile">
      <svg width="406" height="331" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <defs>
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g transform="translate(40 54)">
        ...
        <path
          ...
          mask="url(#d)"
        />
        <rect fill="#FFF" fillRule="nonzero" mask="url(#d)" x="45.967" y="24.246" width="68.95" height="69.707" rx="3" />
